                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="book-price mb-2">
                                            ...
                                            @if($book->discount_rate)
                                                <span></span><strong class="line-through">{{$book->init_price}} PK</strong>
                                            @endif
                                                <span>now</span><strong> {{$book->price}} PK</strong>
                                            @if($book->discount_rate)
                                                <div><strong class="text-danger">Save {{$book->init_price - $book->price}} PK</strong></div>
                                            @endif
                                        </div>
